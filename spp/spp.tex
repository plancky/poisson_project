...
\usepackage[a4paper, total={6.9in, 11in}]{geometry}
...
\begin{document}
	...
	\begin{enumerate}
		\setlength\itemsep{0.01mm}
		\item {\bd{Translate the Physics to mathematics} - Convert the Physical model to a mathematical one, that is, set $f(\vec{r})$}.
	...
	\begin{itemize}
		...
		\item \bd{Week 3 to 5 - CODING PERIOD} - During this time we will code the numerical methods and graph the solutions for the report. (stage 3)
		\item \bd{Week 6 to 7 - FINAL REPORT GENERATION AND CLEANUP} - This period will be spent on the final report generation, this includes explaining all that we have learnt in the report. stage(4 \& 5)
	\end{itemize}	
