...
\begin{document}
	...
	\newsection{TIMELINE}
	\begin{itemize}
		\item \bd{Week 1 \& 2 - UNDERSTANDING PERIOD} - This will include stage 1 \& 2 from our plan of action.
		\item \bd{Week 3 \& 5 - CODING PERIOD} - During this time we will code the numerical methods and graph the solutions for the report. (stage 3)
		\item \bd{Week 6 \& 7 - FINAL REPORT GENERATION AND CLEANUP} - This period will be spent on the final report generation, this includes explaining all that we have learnt in the report. stage(4 \& 5)
	\end{itemize}	
