...
\begin{tikzpicture}[scale =2]
    ...
    \draw (3.5 cm,-2.01cm) node[color=gray,anchor=north] {$i-1$};
    \draw (4.5 cm,-2.01cm) node[color=gray,anchor=north] {$i$};
    \draw (5.5 cm,-2.01cm) node[color=gray,anchor=north] {$i+1$};
    \draw (3.5 cm,-1.99cm) node[color=gray,anchor=south] {$U_{i-1}$};
    \draw (4.5 cm,-1.99cm) node[color=gray,anchor=south] {$U_{i}$};
    \draw (5.5 cm,-1.99cm) node[color=gray,anchor=south] {$U_{i+1}$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=2]
    ...
    \draw[fill=black] (A) circle (1.2pt) (A) node[anchor=north] {$1$};
    \draw[fill=red] (B) circle (1.2pt) (B) node[anchor=north] {$-2$};
    \draw[fill=black] (C) circle (1.2pt) (C) node[anchor=north] {$1$};
    \draw (A) node[color=gray,anchor=south] {$U_{i-1}$};
    \draw (B) node[color=gray,anchor=south] {$U_{i}$};
    \draw (C) node[color=gray,anchor=south] {$U_{i+1}$};
