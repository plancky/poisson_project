...
#    splot sprintf("../dats/dataset4_e-8/%s",file) notitle;
#}
set output 'sor_map.png'
splot '/home/planck/Desktop/secc_project_proposal/dats/dataset4_e-8/sor_poisson2d_0.0125_1.9_1.dat' notitle 
