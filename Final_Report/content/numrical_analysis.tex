...
%      \centering
%      \includegraphics[width=\textwidth]{content/graphs/Jacobi_0125_map.png}
%      \caption{Jacobi}
%      \label{fig:sub1}
%    \end{subfigure}%
%    \begin{subfigure}{.7\textwidth}
%      \centering
%      \includegraphics[width=\linewidth]{content/graphs/Gauss_0125_map.png}
%      \caption{Gauss-Seidel}
%      \label{fig:sub2}
%    \end{subfigure}
%    \begin{subfigure}{.7\textwidth}
%        \centering
%        \includegraphics[width=\linewidth]{content/graphs/SOR_0125_map.png}
